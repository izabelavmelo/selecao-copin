...
public class MathEvaluator
{
    ...
    {
       	if (expression == null) 
       		throw new ExpressionException("Formula vazia");
    ...
    private static Double evaluate(Node n) throws ExpressionException
    {
    ...
    private static Double evaluateExpression(Operator o, Double f1, Double f2) throws ExpressionException
    {
    	
    	
    	if(o == null || f1 == null || f2 == null){
    		throw new ExpressionException("Formula nao pode ser calculada");
    	}
